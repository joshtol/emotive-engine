    ...
    await new Promise<void>((resolve, reject) => {
      execFile(
        ...
        [
          ...
          '-pix_fmt', 'yuv420p',
          '-movflags', '+faststart',
          '-metadata', 'title=Made with Emotive Engine',
          '-metadata', 'artist=Emotive Engine',
          '-metadata', 'comment=https://github.com/joshtol/emotive-engine',
          '-metadata', 'description=Animation created with Emotive Engine',
          '-y',
          tmpOut,
        ],
        { timeout: 60000 },
