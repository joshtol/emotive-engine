...
export default function EducationPage() {
  ...
  // Uses mascot.setPosition() API like the smart-home page for proper positioning
  useEffect(() => {
    if (!mascot) return
    ...
    const updateMascotOnScroll = () => {
      try {
        ...
        // Position calculation using mascot.setPosition() API (like smart-home page)
        // Skip if mascot is attached to an element (LearningSimulation handles its own positioning)
