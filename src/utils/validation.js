...
export class Validator {
    ...
    static validateEmotion(emotion) {
        ...
        if (!validEmotions.includes(normalizedEmotion)) {
            ...
            return ErrorResponse.failure(ErrorTypes.INVALID_EMOTION, message, {
                received: emotion,
                validEmotions,
            });
        }
    ...
    static validateGesture(gesture) {
        ...
        if (!validGestures.includes(normalizedGesture)) {
            ...
            return ErrorResponse.failure(ErrorTypes.INVALID_GESTURE, message, {
                received: gesture,
                validGestures,
            });
        }
