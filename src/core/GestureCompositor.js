/**
 * GestureCompositor - Combines base gesture parameters with emotion and undertone modifiers
 * This class is responsible for calculating final animation parameters based on context
 */
