 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Performance Monitor - Comprehensive Performance Tracking
 ...
 * ║                                   PURPOSE                                         
 * ╠═══════════════════════════════════════════════════════════════════════════════════
 * ║ The WATCHDOG of performance. Tracks FPS, memory usage, render times, and          
 * ║ automatically adjusts quality settings to maintain smooth animation.              
 * ║ Prevents your browser from melting while keeping the orb beautiful!               
 * ╚═══════════════════════════════════════════════════════════════════════════════════
 *
 * ┌───────────────────────────────────────────────────────────────────────────────────
 * │ 📊 METRICS TRACKED                                                                 
 ...
 * │ ⚡ AUTO-OPTIMIZATION                                                               
 * ├───────────────────────────────────────────────────────────────────────────────────
 * │ • Reduces particles when FPS < 45                                                 
 * │ • Simplifies effects when FPS < 30                                                
 * │ • Emergency mode when FPS < 15                                                    
