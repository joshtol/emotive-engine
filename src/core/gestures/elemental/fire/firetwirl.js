 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *  ╔═○─┐ emotive
 *    ●●  ENGINE - Fire Twirl Gesture
 *  └─○═╝
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Firetwirl gesture - 3-ring relay illusion
 * @module gestures/destruction/elemental/firetwirl
 *
 * CONCEPT: Three interlocked camera-billboarded flame-rings arranged in an equilateral
 * triangle. Only one ring's arc segment is visible at a time, cycling between
 * rings so the fire appears to weave through a trinity of rings.
 */

import { buildFireEffectGesture } from './fireEffectFactory.js';

const FIRETWIRL_CONFIG = {
    name: 'firetwirl',
    emoji: '🔥',
    type: 'blending',
    ...
    spawnMode: [
        // Ring A — lower-left — relay 2, CW
        {
            ...
            animation: {
                ...
                renderOrder: 10,
                atmospherics: [
                    { preset: 'smoke', intensity: 0.2, sizeScale: 0.6, progressCurve: 'sustain' },
                ],
                modelOverrides: {
                    'flame-ring': {
                        arcPhase: 0.0,
...
export default buildFireEffectGesture(FIRETWIRL_CONFIG);
