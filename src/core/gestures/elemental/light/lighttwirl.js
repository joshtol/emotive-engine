 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *  ╔═○─┐ emotive
 *    ●●  ENGINE - Light Twirl Gesture
 *  └─○═╝
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Lighttwirl gesture - 3-ring relay illusion
 * @module gestures/destruction/elemental/lighttwirl
 *
 * CONCEPT: Three interlocked camera-billboarded sun-rings arranged in an equilateral
 * triangle. Only one ring's arc segment is visible at a time, cycling between
 * rings so the light appears to weave through a trinity of rings.
 */

import { buildLightEffectGesture } from './lightEffectFactory.js';

const LIGHTTWIRL_CONFIG = {
    name: 'lighttwirl',
    emoji: '✨',
    type: 'blending',
