 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *  ╔═○─┐ emotive
 *    ●●  ENGINE - Watershield Gesture
 *  └─○═╝
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Watershield gesture - gyroscopic splash rings protecting mascot
 * @module gestures/destruction/elemental/watershield
 *
 * CONCEPT: Six large splash-rings anchored at the mascot center on different axes,
...
const SHARED_RING_ANIMATION = {
    ...
    grain: { type: 3, strength: 0.08, scale: 0.3, speed: 0.4, blend: 'multiply' },
    blending: 'normal',
};

const WATERSHIELD_CONFIG = {
    name: 'watershield',
    emoji: '🛡️',
    type: 'blending',
    description: 'Gyroscopic water cage — six tumbling rings form a protective torrent',
    duration: 3000,
    beats: 4,
    intensity: 1.0,
    mascotGlow: 0.4,
    ...
    spawnMode: [
        {
            ...
            animation: {
                ...
                appearAt: 0.0,
                rotate: { axis: 'x', rotations: 3.0, phase: 0 },
                renderOrder: 6,
                modelOverrides: {
                    'splash-ring': {
        ...
        },
        {
            ...
            animation: {
                ...SHARED_RING_ANIMATION,
                appearAt: 0.03,
                rotate: { axis: 'y', rotations: -3.0, phase: 0 },
                renderOrder: 8,
                modelOverrides: {
                    'splash-ring': {
        ...
        },
        {
            ...
            animation: {
                ...SHARED_RING_ANIMATION,
                appearAt: 0.06,
                rotate: { axis: 'x', rotations: 3.0, phase: 60 },
                renderOrder: 10,
                modelOverrides: {
                    'splash-ring': {
        ...
        },
        {
            ...
            animation: {
                ...SHARED_RING_ANIMATION,
                appearAt: 0.09,
                rotate: { axis: 'y', rotations: -3.0, phase: 120 },
                renderOrder: 12,
                modelOverrides: {
                    'splash-ring': {
                        shaderAnimation: { type: 1, arcWidth: 0.8, arcSpeed: 0.45, arcCount: 2 },
        ...
        },
        {
            ...
            animation: {
                ...SHARED_RING_ANIMATION,
                appearAt: 0.12,
                rotate: { axis: 'x', rotations: 3.0, phase: 45 },
                renderOrder: 14,
                modelOverrides: {
                    'splash-ring': {
...
export default buildWaterEffectGesture(WATERSHIELD_CONFIG);
