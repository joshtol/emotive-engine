 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *  ╔═○─┐ emotive
 *    ●●  ENGINE - Voidshield Gesture
 *  └─○═╝
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Voidshield gesture - gyroscopic void rings protecting mascot
 * @module gestures/destruction/elemental/voidshield
 *
 * CONCEPT: Six large void-rings anchored at the mascot center on different axes,
...
const VOIDSHIELD_CONFIG = {
    name: 'voidshield',
    emoji: '🛡️',
    type: 'blending',
    description: 'Gyroscopic void cage — six tumbling rings form a protective darkness',
    duration: 3000,
    beats: 4,
    intensity: 1.0,
    mascotGlow: 0.2,
