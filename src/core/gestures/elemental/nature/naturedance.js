 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *  ╔═○─┐ emotive
 *    ●●  ENGINE - Nature Dance Gesture
 *  └─○═╝
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Naturedance gesture - vertical vine rings dancing upward
 * @module gestures/destruction/elemental/naturedance
 *
 * FEATURES:
 * - 3 vine-ring elements with vertical orientation
...
const NATUREDANCE_CONFIG = {
    name: 'naturedance',
    emoji: '💃',
    type: 'blending',
    description: 'Vertical vine rings dancing and rising',
    duration: 1500,
    beats: 3,
    intensity: 1.3,
    category: 'emanating',
