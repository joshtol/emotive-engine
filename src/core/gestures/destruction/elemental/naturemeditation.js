 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Naturemeditation gesture - relay arc energy flow through 3 vertical rings
 * @module gestures/destruction/elemental/naturemeditation
 *
 * CONCEPT: Three camera-facing vine-rings stacked vertically (bottom → center → top).
...
const NATUREMEDITATION_CONFIG = {
    ...
    emoji: '🧘',
    type: 'blending',
    description: 'Meditative vine relay — growth energy flows upward through three aligned rings',
    duration: 2500,
    beats: 4,
    intensity: 0.7,
    category: 'emanating',
