 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *  ╔═○─┐ emotive
 *    ●●  ENGINE - Naturemeditation Gesture
 *  └─○═╝
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Naturemeditation gesture - dual Star-of-David vine weave
 * @module gestures/destruction/elemental/naturemeditation
 *
 * CONCEPT: Two Star-of-David hexagons — one original, one vertically flipped with
 * reversed rotations. 12 rings total. Each hexagon is a trinity of vine-rings
 * with relay arc handoff creating a weaving growth pattern.
 *
...
const NATUREMEDITATION_CONFIG = {
    name: 'naturemeditation',
    emoji: '🧘',
    type: 'blending',
    description: 'Dual vine weave — nature hexagon meditation',
    duration: 4000,
    beats: 8,
    intensity: 0.7,
    category: 'emanating',
