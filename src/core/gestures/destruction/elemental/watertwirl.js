 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *  ╔═○─┐ emotive
 *    ●●  ENGINE - Water Twirl Gesture
 *  └─○═╝
 * ═══════════════════════════════════════════════════════════════════════════════════════
 *
 * @fileoverview Watertwirl gesture - 3-ring relay illusion
 * @module gestures/destruction/elemental/watertwirl
 *
 * CONCEPT: Three interlocked camera-billboarded splash-rings arranged in an equilateral
 * triangle. Only one ring's arc segment is visible at a time, cycling between
 * rings so the water appears to weave through a trinity of rings.
 */

import { buildWaterEffectGesture } from './waterEffectFactory.js';

const WATERTWIRL_CONFIG = {
    name: 'watertwirl',
    emoji: '💧',
    type: 'blending',
    description: 'Relay water illusion — arc weaves through three interlocked rings',
    duration: 1500,
    beats: 2,
    intensity: 1.5,
    category: 'afflicted',
