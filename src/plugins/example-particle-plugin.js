...
class CustomParticlePlugin {
    ...
    registerBehaviors() {
        ...
        const firefliesBehavior = {
            ...
            initialize(particle) {
                ...
                particle.size =
                    (2 + Math.random() * 2) *
                    particle.scaleFactor *
                    particle.particleSizeMultiplier;
        ...
        const snowBehavior = {
            ...
            update(particle, dt, centerX, centerY) {
                ...
                particle.vx =
                    Math.sin(data.swayPhase) * data.swayAmplitude * 0.01 +
    ...
    getInfo() {
        return {
            ...
            author: 'Emotive Engine Team',
            description:
                'Adds fireflies, snow, and matrix particle effects using the modular system',
        };
    }
}
